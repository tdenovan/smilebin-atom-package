...
class CommentProvider {
  ...
  constructor ({notificationManager, workspace, apolloClient, authenticationProvider}) {
  ...
  async createComment(filePath, commentText, emoticon, startLine, endLine) {
    ...
    startLine = _.findKey(parsedDiff.lineTranslations, ln => ln === startLine)
    endLine = _.findKey(parsedDiff.lineTranslations, ln => ln === endLine)
